package com.leminarelli.paymentmobile;
...
public class PaymentMobileModule extends ReactContextBaseJavaModule implements ServiceConnection, ITransactionListener, ActivityEventListener {
    ...
    public PaymentMobileModule(ReactApplicationContext reactContext) {
        super(reactContext);
        this.reactContext = reactContext;
        this.reactContext.addActivityEventListener(PaymentMobileModule.this);
