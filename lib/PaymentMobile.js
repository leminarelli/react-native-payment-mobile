...
PaymentMobileEvents.addListener("asynchronousPaymentCallback", () => {
...
export default class PaymentMobileComponent extends Component {
  static propTypes = {
    mode: PropTypes.oneOf([TransactingModes.TEST, TransactingModes.LIVE])
      .isRequired,
  ...
  componentDidMount() {
    ...
    PaymentMobileComponent.initPaymentProvider(mode);
